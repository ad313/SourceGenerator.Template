...
{
    [Log(LogName = "this is bbb", Type = EnumType.b)]
    [Log2(LogName = "this is bbb2", Type = EnumType.b)]
    //[IgnoreAop]
    ...
    public class AopClass1 : IAopClass1
    {
        ...
        //[Display]
        [Log(LogName = "this is aaa", Type = EnumType.a)]
        [Log2(LogName = "this is aaa2", Type = EnumType.a)]
